...
<body>
    ...
    <form method="POST" action="{{ route('estadoCuenta.vistaPrevia') }}" class="formulario2">
        @csrf
    ...
    <script>
        function aplicarFiltros() {
            ...
            window.location.href = `{{ route('estadosCuenta.seleccionarEstudiante') }}?${params.toString()}`;
        }
    </script>
</body>
</html>
